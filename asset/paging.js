function initPaging() {
    var limitpage = 0;
    limitpage = parseInt($("#limit").val())+20;
...
function updatelist_absen(id, baseUrl, cntlName, page, pagenumber,ctrlName) {
    var pnumber = 0;
    var functionName = '';
    if (pagenumber) {
        pnumber = pagenumber;
...
function updatelist_approval(id, baseUrl, cntlName, page, pagenumber,ctrlName) {
    var pnumber = 0;
    var functionName = '';
    if (pagenumber) {
        pnumber = pagenumber;
