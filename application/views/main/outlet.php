                        ...
                        <form id="merchant_omzet_form" method="post" action="?" enctype="multipart/form-data">
                            <div class="col-md-12" style="padding:10px;">
                                ...
                                <div class="form-group col-md-5" style="padding-top:20px">
                                    <div class="btn-group">
                                        <button type="button" onclick="javascript:process_outlet_all_data('<?= base_url() ?>', '<?= $this->router->fetch_class() ?>', 'merchant_omzet_form', 'outlet_list');" class="btn btn-primary">Cari<i class="icon-plus"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
